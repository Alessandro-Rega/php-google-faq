    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li>Tecnologie</li>
                <li class="selezionato">Domande Frequenti</li>
            </ul>
        </nav>
    </header>
    <div class="cont">
